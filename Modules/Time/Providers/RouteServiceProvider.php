...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string|null
     */
    protected $namespace = 'Modules\\Time\\Http\\Controllers';
    ...
    {
        return config('time.routing.paths');
    }
    ...
    {
        if (empty(config('time.routing.middleware'))) {
            return;
        }

        foreach (config('time.routing.middleware') as $alias => $class) {
