...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string|null
     */
    protected $namespace = 'Modules\\Hierarchy\\Http\\Controllers';
    ...
    {
        return config('hierarchy.routing.paths');
    }
    ...
    {
        if (empty(config('hierarchy.routing.middleware'))) {
            return;
        }

        foreach (config('hierarchy.routing.middleware') as $alias => $class) {
