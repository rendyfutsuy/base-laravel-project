...
class RegisterTokenTest extends TestCase
{
    ...
    public function user_can_register_with_otp_email_sent()
    {
        ...
        $userMock->email = 'test.user.mobileregister@mailinator.com';
        ...
        $dbTableMock->shouldReceive('where')
            ->with('email', 'test.user.mobileregister@mailinator.com')
            ->andReturnSelf();
        $dbTableMock->shouldReceive('where')
            ->andReturnSelf();
        ...
        $response = $this->withHeaders([
            ...
            'name' => 'Random Name',
            'email' => 'test.user.mobileregister@mailinator.com',
            'password' => 'userApp123!',
    ...
    public function register_must_use_post_method()
    {
        $response = $this->withHeaders([
            'Accept' => 'application/json',
        ])->getJson(route('api.authentication.mobile.register'), [
            'name' => 'random name',
            'email' => 'test.user.mobileregister@mailinator.com',
            'password' => 'userApp123!',
        ]);
