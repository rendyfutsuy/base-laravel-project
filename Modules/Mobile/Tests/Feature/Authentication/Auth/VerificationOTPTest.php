...
class VerificationOTPTest extends TestCase
{
    ...
    public function user_can_access_verification_otp_code_with_otp_token()
    {
        ...
        $userMock->email = 'test.user.otp.mobile@mailinator.com';
        $userMock->name = 'Test User';

        // Mock OTP for middleware
        ...
        ])->postJson(route('api.authentication.mobile.verification.otp'), [
            'code' => '123456',
        ]);
    ...
    public function verification_otp_code_fail_because_otp_code_not_registered()
    {
        ...
        $userMock->email = 'test.user.otp.false.mobile@mailinator.com';
        $userMock->name = 'Test User';
    ...
    public function user_can_access_resend_email_otp_for_refresh_otp_code()
    {
        ...
        $userMock->email = 'test.user.otp.resend.mail.mobile@mailinator.com';
        $userMock->name = 'Test User';
        ...
        $response = $this->withHeaders([
            ...
            'Accept' => 'application/json',
        ])->postJson(route('api.authentication.mobile.verification.resend.email.otp'));
