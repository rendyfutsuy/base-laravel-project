...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string|null
     */
    protected $namespace = 'Modules\\Mobile\\Http\\Controllers';
    ...
    {
        return config('mobile.routing.paths');
    }
    ...
    {
        if (empty(config('mobile.routing.middleware'))) {
            return;
        }

        foreach (config('mobile.routing.middleware') as $alias => $class) {
