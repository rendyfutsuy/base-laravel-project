...
class RouteServiceProvider extends ServiceProvider
{
    ...
    {
        return config('user-management.routing.paths');
    }
    ...
    {
        if (empty(config('user-management.routing.middleware'))) {
            return;
        }

        foreach (config('user-management.routing.middleware') as $alias => $class) {
